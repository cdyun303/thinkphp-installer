...
class ThinkFramework extends LibraryInstaller
{
    ...
    {
        if ('cdyun/thinkphp-framework' !== $package->getPrettyName()) {
            throw new InvalidArgumentException('Unable to install this library! Thinkphp Framework '.$package->getPrettyName());
        }
    ...
    {
        return 'thinkphp-framework' === $packageType;
    }
}